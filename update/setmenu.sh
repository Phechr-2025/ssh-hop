...
;;
16)
wget -q -O /usr/bin/xraychanger "https://raw.githubusercontent.com/Phechr-2025/ssh-hop/main/tools/xraychanger.sh" && chmod +x /usr/bin/xraychanger && xraychanger
;;
17)
nano /etc/issue.net
;;
...
19)
clear
wget -q -O /usr/bin/swapram "https://raw.githubusercontent.com/Phechr-2025/ssh-hop/main/tools/swapram.sh" && chmod +x /usr/bin/swapram && swapram
;;
20)
clear
menu
