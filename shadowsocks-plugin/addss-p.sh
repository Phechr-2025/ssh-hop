...
echo -e "Link Aplikasi gost-plugin: #://$MYIP:89/gost-plugin-android.apk"
echo -e "Link Aplikasi v2ray-plugin: #://$MYIP:89/v2ray-plugin-universal.apk"
echo -e "Link Aplikasi xray-plugin: #://$MYIP:89/xray-plugin-universal.apk"
echo -e "ganti tanda # menjadi http"
echo -e "========================="
echo -e "Script Mod By Phechr-2025"
