...
fisabiliyusri="raw.githubusercontent.com/Phechr-2025/ssh-hop/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By Phechr-2025"
...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Phechr-2025/ssh-hop/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Phechr-2025/ssh-hop/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Phechr-2025/ssh-hop/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
